...
- Feature engineering con faltantes como faltantes (no se inventa xG), ventanas
  desplazadas para evitar fuga de información y matriz de modelado que excluye
  explícitamente las estadísticas del propio partido.
...
separa cronológicamente entrenamiento/validación/prueba por fecha de jornada y
mide log-loss, Brier, calibración y rendimiento fuera de muestra. No uses el sistema como consejo
